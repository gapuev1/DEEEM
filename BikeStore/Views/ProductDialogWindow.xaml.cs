    ...
    public partial class ProductDialogWindow : Window
    {
            ...
            if (product != null)
            {
                ...
                if (!string.IsNullOrEmpty(product.ImagePath))
                {
                    try
                    {
                        ...
                        {
                            PreviewImage.Source = new BitmapImage(new Uri(imageFullPath));
        ...
        private void SelectImageBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog() == true)
            {
                ...
                {
                    MessageBox.Show($"Ошибка загрузки фото: {ex.Message}", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Warning);
                }
            }
        }
